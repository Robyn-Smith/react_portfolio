      ...
      <article style={{display:"flex", flexWrap: "wrap", justifyContent:"space-around"}}>
        ...
        <section class="box">
            ...
            <section class="box">
              ...
              <p>This <span style={{fontWeight: 'bold'}}>API</span> gives a social network web application functionality, allowing users to share their thoughts, react to friend's thoughts, and create a friend list. The API for my social network uses a <span style={{fontWeight:'bold'}}>NoSQL</span> database so that the website can handle large amounts of unstructured data. <span style={{fontWeight:'bold'}}>Express.js</span> was used for routing, and the <span style={{fontWeight:'bold'}}>Mongoose ODM models</span> are synced to the <span style={{fontWeight:'bold'}}>MongoDB database</span>. Seed data has not been added to this code, instead the user can enter their own data using <span style={{fontWeight:'bold'}}>Insomnia</span> or <span style={{fontWeight:'bold'}}>Postman</span> after installing the API. The user can then use the GET, POST, PUT and DELETE methods to retrieve, edit or remove formatted <span style={{fontWeight:'bold'}}>JSON</span> data.
              </p>
            ...
            <section class="box">
              ...
              <section class="box">
                  ...
                  <p>This application is a text editor that runs in the browser. The app is a single-page application that meets the <span style={{fontWeight:'bold'}}>PWA</span> criteria. Additionally, this application features a number of data persistence techniques that serve as redundancy in case one of the options is not supported by the browser. The application will also function offline. To build this text editor, an existing application and code implementing methods for getting and storing data to an <span style={{fontWeight:'bold'}}>IndexedDB</span> database were provided. The package called <span style ={{fontWeight:'bold'}}>idb</span> was used in this application, which is a lightweight wrapper around the <span style={{fontWeight:'bold'}}>IndexedDB API</span>. It features a number of methods that are useful for storing and retrieving data, and is used by companies like Google and Mozilla.</p>
